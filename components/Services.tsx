...
const taxiTypes: TaxiType[] = [
  {
    id: 'general',
    name: 'Taxi General',
    description: 'Servicio de transporte profesional para todo público. Nuestros conductores certificados te llevan con seguridad a tu destino en unidades modernas y cómodas.',
    features: ['Servicio para todo público', 'Conductores profesionales certificados', 'Flota moderna con aire acondicionado', 'Monitoreo GPS 24/7'],
  ...
  },
  {
    id: 'rosa',
    name: 'Taxi Rosa',
    description: 'Servicio para toda la familia conducido por mujeres profesionales capacitadas. Un espacio seguro y cómodo diseñado especialmente para ellas.',
    features: ['Ideal para toda la familia', 'Conductoras certificadas y capacitadas', 'Unidades modernas con aire acondicionado', 'Protocolos especiales de seguridad'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <ScrollReveal direction="up" className="text-center mb-10 md:mb-16">
          ...
          <p className="mt-4 text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            Flota moderna y diversa con conductores certificados.
          </p>
        </ScrollReveal>
              ...
              <div className="h-56 md:h-64 overflow-hidden relative group">
                ...
                <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black/60 to-transparent">
                  <p className="text-white font-mono text-sm opacity-90 flex items-center gap-2">
                    ...
                    Modelo Reciente | Aire Acondicionado
                  </p>
                </div>
              </div>
